export const heroDetails = {
  kicker: "TEMRINK FOR SMBS",
  heading: "AI, Automation & IT Helpdesk for SMBs",
  subheading:
  ...
  partners: [
    ...
    { name: "Bitdefender", src: "/partners/bitdefender.png", width: 240, height: 72 },
    { name: "Veeam",       src: "/partners/veeam.png",       width: 240, height: 72 },
  ],
} as const;
